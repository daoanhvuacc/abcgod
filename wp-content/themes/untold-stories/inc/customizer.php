...
function untoldstories_customize_register( $wpc ) {
	...
	$wpc->add_section( 'other', array(
		'title'       => esc_html_x( 'Other', 'customizer section title', 'untold-stories' ),
		'description' => esc_html__( 'Other options affecting the whole site.', 'untold-stories' ),
		'priority'    => 120
	) );
	...
	$wpc->add_setting( 'custom_css', array(
		'default'              => '',
		'sanitize_callback'    => 'untoldstories_sanitize_custom_css',
		'sanitize_js_callback' => 'untoldstories_sanitize_custom_css',
	) );
	$wpc->add_control( 'custom_css', array(
		'type'    => 'textarea',
		'section' => 'other',
		'label'   => esc_html__( 'Custom CSS', 'untold-stories' ),
	) );
