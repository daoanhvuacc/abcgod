...
function untoldstories_bind_metabox_to_page_template( $metabox_id, $template_file, $js_var ) {
...
function untoldstories_bind_metabox_to_post_format( $metabox_id, $post_format, $js_var ) {
